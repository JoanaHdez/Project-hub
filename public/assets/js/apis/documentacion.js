...
const apiHeadersContenedor =
  document.getElementById(
    "api-headers-contenedor",
  );

const apiHeadersBody =
  document.getElementById(
    "api-headers",
  );

const apiHeadersVacio =
  document.getElementById(
    "api-headers-vacio",
  );
...
const apiParametrosContenedor =
  document.getElementById(
    "api-parametros-contenedor",
  );

const apiParametrosBody =
  document.getElementById(
    "api-parametros",
  );

const apiParametrosVacio =
  document.getElementById(
    "api-parametros-vacio",
  );

const apiEjemploContenedor =
  document.getElementById(
    "api-ejemplo-contenedor",
  );

const apiEjemploCodigo =
  document.getElementById(
    "api-ejemplo",
  );

const apiEjemploVacio =
  document.getElementById(
    "api-ejemplo-vacio",
  );

const apiEjemploMetodo =
  document.getElementById(
    "api-ejemplo-metodo",
  );

const botonCopiarEjemplo =
  document.getElementById(
    "copiar-ejemplo",
  );

const apiRespuestasContenedor =
  document.getElementById(
...
const fichaApiProyecto =
  document.getElementById(
    "ficha-api-proyecto",
  );

const fichaApiEstado =
  document.getElementById(
    "ficha-api-estado",
  );

const fichaApiRepositorio =
  document.getElementById(
...
catalogoApis?.addEventListener(
  ...
  (event) => {
    ...
    if (apiNombre) {
      apiNombre.textContent =
        nombre;
    }

    if (apiMetodo) {
      apiMetodo.textContent =
        metodo;
    }

    if (apiDescripcion) {
      apiDescripcion.textContent =
        descripcion;
    }

    if (apiProyecto) {
      apiProyecto.textContent =
        proyecto;
    }
    ...
    if (apiAutenticacion) {
      apiAutenticacion.textContent =
        autenticacion;
    }

    if (apiEndpointMetodo) {
      apiEndpointMetodo.textContent =
        metodo;
    }
    ...
    if (fichaApiProyecto) {
      fichaApiProyecto.textContent =
        proyecto || "—";
    }

    if (fichaApiEstado) {
      fichaApiEstado.textContent =
        estado || "—";
    }

    if (fichaApiRepositorio) {
      fichaApiRepositorio.textContent =
        repositorio || "—";
    }

    if (fichaApiRuta) {
      fichaApiRuta.textContent =
        ruta || "—";
    }

    if (fichaApiServidor) {
      fichaApiServidor.textContent =
        servidor || "—";
    }
  },
);
...
function renderHeaders(headers) {
  ...
  if (
    ...
    apiHeadersContenedor.hidden =
      true;

    apiHeadersVacio.hidden =
      false;

    apiHeadersVacio.textContent =
...
function renderParametros(
  ...
  if (
    ...
    apiParametrosContenedor.hidden =
      true;

    apiParametrosVacio.hidden =
      false;
...
function renderEjemplo(
  ...
  if (
    ...
    apiEjemploContenedor.hidden =
      true;

    apiEjemploVacio.hidden =
      false;

    apiEjemploVacio.textContent =
  ...
  apiEjemploMetodo.textContent =
    metodo;

  apiEjemploMetodo.className =
    `badge-metodo badge-metodo--${metodo.toLowerCase()}`;

  apiEjemploCodigo.innerHTML =
    `${url}
...
function renderRespuestas(
  ...
  if (
    ...
    apiRespuestasContenedor.hidden =
      true;

    apiRespuestasVacio.hidden =
      false;
...
if (botonCopiarEjemplo) {
  botonCopiarEjemplo.addEventListener(
    "click",
    async () => {
      if (!apiEjemploCodigo) {
        return;
      ...
      try {
        ...
        botonCopiarEjemplo.textContent =
          "¡Copiado!";
